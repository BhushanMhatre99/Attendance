...
def student_view(request):
    ...
    return render_to_response("student_view.html",{'students' : students})
    ...
    if request.method == 'POST':
        if request.session.has_key('is_logged'):
            ...
            for teacher in res:
                ...
                cursor.execute(sql)
    return render_to_response("teacher_view.html",{'teachers' : teachers, 'attend_success' : attend_success})
...
def view_attendance(request):
    ...
    for teacher in res:
        teacher_list.append(teacher[0])
    return render_to_response("view_attendance.html", {'result': teacher_list})
...
def teacher_view_student(request):
    ...
    return render_to_response("teacher_view_student.html", {'student_list': student_list})
...
def view_attendance_student(request):
    ...
    return render_to_response("view_attendance_student.html",{'students' : student_list})